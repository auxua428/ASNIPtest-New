...
**Linux / macOS**
```bash
curl -fsSL https://raw.githubusercontent.com/auxua428/ASNIPtest-New/main/install.sh | bash
cmtjd
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/auxua428/ASNIPtest-New/main/uninstall.sh | bash
```
